function notifyMe(message, status, progress) {
      ...
      function limpar() {
          var lista = $('#lista').val();
          if (lista.length == 0) {
              document.getElementById("demo").innerHTML = 'Load the list before cleaning it!';
              //notifyMe("O campo não contém nenhuma lista para ser limpa", "Erro ao limpar a lista de checagem.");
              audio2.play();
              return;
          } else {
              document.getElementById("lista").value = '';
              document.getElementById("demo").innerHTML = 'Clean list.';
              audio.play();
      ...
      function start() {
          var lista = $('#lista').val();
          if (lista.length == 0) {
              document.getElementById("demo").innerHTML = 'UPLOAD READY!';
      ...
      function check(cc2, separador, id) {
                    ...
                    xmlhttp.onreadystatechange = function()
                    {
                        ...
                        if (xdata.match("APPROVED")) {
                          document.getElementById("demo").innerHTML = 'APPROVED CARD DETECTED BOI!';
